...
from keras.layers import Conv2D, Input, BatchNormalization, LeakyReLU, ZeroPadding2D, UpSampling2D
from keras.layers import add, concatenate  # Updated line
from keras.models import Model
    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite("C:/Projects/Traffic-Signal-Violation-Detection-System/Detected Images/violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = "C:/Projects/Traffic-Signal-Violation-Detection-System/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
